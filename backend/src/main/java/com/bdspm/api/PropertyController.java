...
import com.bdspm.service.PropertyService;
...
public class PropertyController {
    ...
    public ResponseEntity<PropertyDto> createProperty(@Valid @RequestBody PropertyRequest request) {
        PropertyDto dto = propertyService.createProperty(request);
        return ResponseEntity.created(URI.create("/api/properties/" + dto.id())).body(dto);
    }
